...
SECRET_KEY = 'django-insecure-*v)j6x=hxb@^s6afd$(5wnfic-cel08c*84i6k(1inj)da74@3'
...
AUTHENTICATION_BACKENDS = [
    'user_app.email_backend.EmailBackend',  # Use your custom email authentication backend
...
SIMPLE_JWT = {
    ...
    'USER_ID_FIELD': config('SIMPLE_JWT_USER_ID_FIELD', default='id'),
}